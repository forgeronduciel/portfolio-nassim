...
const projetsEntreprise: Activite[] = [
  {
    id: "masterisation",
    titre: "Masterisation & Déploiement de postes",
    soustitre: "MDT · WDS · Sysprep · PXE · Active Directory",
    annee: "2025-2026",
    badge: "Projet majeur",
    icon: <Server size={22} />,
    ...
    objectifs:
      "Mettre en place une chaîne complète de masterisation et de déploiement automatisé de postes Windows en entreprise : création d'une image de référence (master), configuration via MDT/WDS, déploiement par PXE et intégration automatique au domaine Active Directory.",
    travaux: [
      "Création et configuration du serveur MDT (Microsoft Deployment Toolkit) sur Windows Server",
      "Élaboration du master Windows 11 : installation, personnalisation, Sysprep et capture WIM",
      "Configuration du serveur WDS pour le démarrage réseau PXE des postes cibles",
      "Automatisation de l'intégration au domaine Active Directory (AFR.LOCAL) en post-déploiement",
      "Déploiement des GPO et logiciels via séquences de tâches MDT",
      "Tests de déploiement sur machines virtuelles Proxmox avant mise en production",
      "Rédaction de la procédure de masterisation et du guide de déploiement",
    ],
    technologies: [
      { label: "MDT", color: "bg-blue-500/10 text-blue-300 border-blue-700/30" },
      { label: "WDS / PXE", color: "bg-cyan-500/10 text-cyan-300 border-cyan-700/30" },
    ...
    competences: ["Déploiement", "Windows Server", "Active Directory", "Automatisation", "Réseau"],
    resultats:
      "Chaîne de masterisation opérationnelle permettant de déployer un poste Windows configuré et intégré au domaine en moins de 20 minutes, réduisant significativement le temps d'intervention sur le parc.",
